...
//    [name sizeWithAttributes:<#(nullable NSDictionary<NSString *,id> *)#>]
    UIButton *btn = [UIButton buttonWithType:UIButtonTypeCustom];
    btn.backgroundColor = [UIColor clearColor];
...
+ (UIBarButtonItem *)initWithImage:(NSString *)imageName withName:(NSString *)name customSet:(void(^)(UIButton *btn))setBlock
{
    CGSize size = [name sizeWithFont:[UIFont boldSystemFontOfSize:15.0]];
    UIButton *btn = [UIButton buttonWithType:UIButtonTypeCustom];
    btn.backgroundColor = [UIColor clearColor];
