...
@interface FaceToolBar:NSObject <HPGrowingTextViewDelegate,UIScrollViewDelegate,UIActionSheetDelegate>
...
@property(nonatomic,retain) UIButton *btnKnowledge;
@property(nonatomic,retain) UIButton *btnSessionMore;
