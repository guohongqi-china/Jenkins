...
-(void)initView
{
    ...
    self.bgView.backgroundColor = [SkinManage colorNamed:@"All_textField_bg_color"];
    [self addSubview:_bgView];
    
    self.cancelBtn = [UIButton buttonWithType:UIButtonTypeCustom];
    self.cancelBtn.frame = CGRectMake(0, 5.5, 50, 31);
    [self.cancelBtn setTitleColor:[SkinManage colorNamed:@"Menu_Title_Color"] forState:UIControlStateNormal];
    ...
    self.titleLab.textColor = [SkinManage colorNamed:@"Input_Title"];
    [self.bgView addSubview:_titleLab];
    
    self.sendBtn = [UIButton buttonWithType:UIButtonTypeCustom];
    self.sendBtn.frame = CGRectMake(kScreenWidth-50, 5.5, 50, 31);
    [self.sendBtn setTitleColor:[SkinManage colorNamed:@"Menu_Title_Color"] forState:UIControlStateNormal];
    ...
    self.inputTextView.backgroundColor = [SkinManage colorNamed:@"All_textField_bg_color"];
    self.inputTextView.textColor = [SkinManage colorNamed:@"Menu_Title_Color"];
