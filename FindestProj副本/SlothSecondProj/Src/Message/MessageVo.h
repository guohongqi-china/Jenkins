...
@property (nonatomic) int nComeFromType;                            //0-web; 1-ios; 2-android; 3-RSS; 4-Email; 5-微博; 6-微信; 15-汽车工单接口;
...
@property (nonatomic, strong) NSString *strContentType;         //关联类型	A-附件，B-约会，C-投票, D-图片,T-标签,W-工单评分
...
@property (nonatomic) int  nSendAllPeople;      //是否发给所有人 (1:是,0:否)
//外部邮箱
