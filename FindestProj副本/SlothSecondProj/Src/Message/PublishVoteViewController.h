...
@interface PublishVoteViewController : QNavigationViewController<UITableViewDataSource, UITableViewDelegate,UIGestureRecognizerDelegate,UIScrollViewDelegate,ChooseUserAndGroupDelegate,UIActionSheetDelegate,UIImagePickerControllerDelegate,UINavigationControllerDelegate,UITextFieldDelegate,CustomDatePickerDelegate>
...
//option data
@property (nonatomic)NSInteger nOptionId;
...
//8.vote
@property (nonatomic,strong) UITableView *tableViewVote;
