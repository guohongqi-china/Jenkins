...
- (void)viewDidLoad
{
    ...
    self.txtName.backgroundColor = [SkinManage colorNamed:@"Page_BK_Color"];
...
- (void)modifyDiscussionName
{
    ...
    else
    {
        ...
        [ServerProvider renameChatDiscussion:self.m_chatObjectVo andNewName:txtName.text result:^(ServerReturnInfo *retInfo) {
