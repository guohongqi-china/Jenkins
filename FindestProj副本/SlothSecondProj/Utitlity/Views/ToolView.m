...
- (id)initWithFrame:(CGRect)frame
{
    ...
    if (self)
    {
        ...
        //        //视频
        //        rect.origin.x += rect.size.width + padding;
        //        UIButton *videoButton = [Utils buttonWithImage:[UIImage imageNamed:@"video"] frame:rect target:self action:@selector(videoButton:)];
        //        [topView addSubview:videoButton];
        //        //文档
        //        rect.origin.x += rect.size.width + padding;
        //        UIButton *fileButton = [Utils buttonWithImage:[UIImage imageNamed:@"file"] frame:rect target:self action:nil];
        //        [topView addSubview:fileButton];
        //        //网盘
        //        rect.origin.x += rect.size.width + padding;
        //        UIButton *diskButton = [Utils buttonWithImage:[UIImage imageNamed:@"disk"] frame:rect target:self action:nil];
        //        [topView addSubview:diskButton];
        
        //创建ScrollView存放附件
        contentView = [[UIScrollView alloc] initWithFrame:CGRectMake(0, 51, kScreenWidth, 238)];
        contentView.backgroundColor = [SkinManage colorNamed:@"Function_BK_Color"];
