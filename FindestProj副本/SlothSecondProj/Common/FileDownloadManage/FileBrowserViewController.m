...
- (void)refreshView
{
    ...
    if (fileExists && bSupportByWebView)
    {
        ...
        if (iOSPlatform >= 8)
        {
            ...
            wkWebViewDoc.frame = CGRectMake(0, 0, kScreenWidth,kScreenHeight-NAV_BAR_HEIGHT);
        }
        else
        {
            webViewDoc.hidden = NO;
            webViewDoc.frame = CGRectMake(0, 0, kScreenWidth,kScreenHeight-NAV_BAR_HEIGHT);
        }
    ...
    else
    {
        ...
        self.m_scrollView.frame = CGRectMake(0, 0, kScreenWidth,kScreenHeight-NAV_BAR_HEIGHT);
