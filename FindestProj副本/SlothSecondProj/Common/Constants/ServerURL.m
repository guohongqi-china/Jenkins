...
//博瑞测试
static NSString *g_restPrefixURL    = @"http://vn-functional.chinacloudapp.cn/vx/";
/**正式环境测试*/

//static NSString *g_restPrefixURL    = @"http://115.28.46.211:10002/vx_test/api/";

static NSString *g_chatPrefixURL	= @"http://vn-functional.chinacloudapp.cn:10015/";
static NSString *g_nginxPrefixURL	= @"http://vn-functional.chinacloudapp.cn/vx-app/";

#define WEB_SERVER_TEST         //区别调试版本和发布版本
...
static NSString *g_restPrefixURL	= @"http://115.28.46.211:10002/vx_test/api/";
//Node聊天服务
static NSString *g_chatPrefixURL	= @"http://smr.vivakiexchange.com.cn:10015/";
//Ngnix服务http://smr.vivakiexchange.com.cn/vx-app/
static NSString *g_nginxPrefixURL	= @"http://smr.vivakiexchange.com.cn:10015/";

#define WEB_SERVER_RELEASE         //区别调试版本和发布版本
...
static NSString *g_syncAllMemberURL	= @"mobile/webUser/getAttentionListByPage";
static NSString *g_collectionURL	= @"mobile/store/create";
static NSString *g_doNotCollectionURL	= @"mobile/store/delete/1/";
static NSString *g_Notification	= @"/mobile/notice/list";
static NSString *g_shenhe	= @"mobile/blog/blogs";
static NSString *g_judgeShenhe	= @"mobile/blog/publish/";
static NSString *g_regectURL	= @"mobile/blog/reject";
...
static NSString * const g_answerSolutionURL       = @"mobile/answer/solutionQuestion";
...
static NSString *g_cancelReserveMeetingRoomURL = @"mobile/meetingRoom/cancel/booklist";
...
static NSString *g_answerDetailURL = @"mobile/3.0/answer";
...
static NSString *g_answerCommentListByPageURL = @"mobile/3.0/answer/comment/list";
static NSString *g_activityPraiseActionURL = @"mobile/3.0/activity/mention";
//对某回答的评论点赞或取消赞
static NSString *g_answerCommentMentionURL = @"mobile/3.0/answer/comment/mention";
...
static NSString *g_deleteAnswerCommentURL = @"mobile/3.0/answer/comment/delete";
static NSString *g_activityCreateCommentURL = @"mobile/3.0/activity/comment/create";
static NSString *g_answerCreateCommentURL = @"mobile/3.0/answer/comment/create";
...
static NSString *g_switchCommunityURL = @"mobile/3.0/user/switch";
static NSString *g_communityDetailURL = @"console/2.0/org";

//http://vn-functional.chinacloudapp.cn/vx/mobile/store/create
//其他第三方接口/////////////////////////////////////////////////////////////////////////////////
#if defined(WEB_SERVER_TEST) //测试环境

//微信名片接口
//static NSString *g_viewWeixinCardURL = @"http://mgo.pre.chexiang.com/wxcard/show?tzhUserId=";
//static NSString *g_editWeixinCardURL = @"http://mgo.pre.chexiang.com/wxcard/cardEdit?tzhUserId=";
static NSString *g_viewWeixinCardURL = @"http://mgo.sit.chexiang.com/wxcard/show.htm?tzhUserId=";
static NSString *g_editWeixinCardURL = @"http://mgo.sit.chexiang.com/wxcard/cardEdit.htm?tzhUserId=";
static NSString *g_companyInfoURL = @"http://mgo.sit.chexiang.com/wxcard/pageChange?pageName=wx-company";

//车享家接口
static NSString *g_uploadIDCardURL = @"http://jad.sit.chexiang.com/imgReconRest/doReconIDCardSecondFront";
static NSString *g_uploadDriveLicenseURL = @"http://jad.sit.chexiang.com/imgReconRest/doReconDriveLicense";
static NSString *g_uploadVehicleLicenseURL = @"http://jad.sit.chexiang.com/imgReconRest/doReconVehicleLicense";

//车享H5(预约查询、我的工单、我的工资、我的排班)
static NSString *g_chexiangWorkbenchURL = @"http://m.jia.pre.com/tzh/tzhWorkBench.htm?empNo=";

#elif defined(WEB_SERVER_RELEASE) //正式环境

static NSString *g_viewWeixinCardURL = @"http://mgo.chexiang.com/wxcard/show.htm?tzhUserId=";
static NSString *g_editWeixinCardURL = @"http://mgo.chexiang.com/wxcard/cardEdit.htm?tzhUserId=";
static NSString *g_companyInfoURL = @"http://mgo.chexiang.com/wxcard/pageChange?pageName=wx-company";
//static NSString *g_viewWeixinCardURL = @"http://mgo.pre.chexiang.com/wxcard/show.htm?tzhUserId=";
//static NSString *g_editWeixinCardURL = @"http://mgo.pre.chexiang.com/wxcard/cardEdit.htm?tzhUserId=";
//static NSString *g_companyInfoURL = @"http://mgo.pre.chexiang.com/wxcard/pageChange?pageName=wx-company";


static NSString *g_uploadIDCardURL = @"http://jad.chexiang.com/imgReconRest/doReconIDCardSecondFront";
static NSString *g_uploadDriveLicenseURL = @"http://jad.chexiang.com/imgReconRest/doReconDriveLicense";
static NSString *g_uploadVehicleLicenseURL = @"http://jad.chexiang.com/imgReconRest/doReconVehicleLicense";

static NSString *g_chexiangWorkbenchURL = @"http://m.jia.chexiang.com/tzh/tzhWorkBench.htm?empNo=";
...
{
    NSString *strRetURL = @"";
    if ((id)strURL == [NSNull null] || strURL == nil || strURL.length == 0)
    {
        strRetURL = @"";
    }
    else
...
+ (NSString *)getWholeNginxURL:(NSString *)strURL
{
    NSString *strRetURL = @"";
    if ((id)strURL == [NSNull null] || strURL == nil || strURL.length == 0)
    {
    ...
    else
    {
        ...
        else
        {
            ...
            strRetURL = [NSString stringWithFormat:@"%@%@",g_nginxPrefixURL,strURL];
        }
    }
    return strRetURL;
}
...
//    return g_updateAppURL;
    return @"itms-services://?action=download-manifest&amp;url=http://192.168.16.104:8188/downloadFile/test/manifest.plist";
}
...
+ (NSString *)getCollectionRUL{
    return [NSString stringWithFormat:@"%@%@", g_restPrefixURL,g_collectionURL];
}
+ (NSString *)doNotCollectionRUL{
    return [NSString stringWithFormat:@"%@%@", g_restPrefixURL,g_doNotCollectionURL];
}
+ (NSString *)rejectURL{
    return [NSString stringWithFormat:@"%@%@", g_restPrefixURL,g_regectURL];
}
+ (NSString *)Judgeshenhe{
    return [NSString stringWithFormat:@"%@%@", g_restPrefixURL,g_judgeShenhe];
}
+ (NSString *)shenhe{
    return [NSString stringWithFormat:@"%@%@", g_restPrefixURL,g_shenhe];
}

+ (NSString *)NotificationURL{
    return [NSString stringWithFormat:@"%@%@", g_restPrefixURL,g_Notification];
}
...
+ (NSString *)getDeleteAnswerCommentURL
{
    return [NSString stringWithFormat:@"%@%@", g_restPrefixURL, g_deleteAnswerCommentURL];
}
...
+ (NSString *)getAnswerDetailURL
{
    return [NSString stringWithFormat:@"%@%@", g_restPrefixURL, g_answerDetailURL];
}
...
+ (NSString *)getAnswerCommentListByPageURL
{
    return [NSString stringWithFormat:@"%@%@", g_restPrefixURL, g_answerCommentListByPageURL];
}
...
+ (NSString *)getAnswerCreateCommentURL
{
    return [NSString stringWithFormat:@"%@%@", g_restPrefixURL, g_answerCreateCommentURL];
}
...
+ (NSString *)tableURL{
    return [NSString stringWithFormat:@"%@%@", g_restPrefixURL, @"mobile/tag/query/M?t=time_1468309652528"];
...
+ (NSString *)getAnswerCommentMentionURL
{
    return [NSString stringWithFormat:@"%@%@", g_restPrefixURL, g_answerCommentMentionURL];
}

+ (NSString *)getSwitchCommunityURL
{
    return [NSString stringWithFormat:@"%@%@", g_restPrefixURL, g_switchCommunityURL];
}

+ (NSString *)getCommunityDetailURL
{
    return [NSString stringWithFormat:@"%@%@", g_restPrefixURL, g_communityDetailURL];
}

//微信名片接口/////////////////////////////////////////////////////////////////////////////////
+ (NSString *)getViewWeixinCardURL
{
    return g_viewWeixinCardURL;
}

+ (NSString *)getEditWeixinCardURL
{
    return g_editWeixinCardURL;
}

+ (NSString *)getCompanyInfoURL
{
    return g_companyInfoURL;
}

//车享家服务URL///////////////////////////////////////////////////////////////////
+ (NSString *)getUploadIDCardURL
{
    return g_uploadIDCardURL;
}

+ (NSString *)getUploadDriveLicenseURL
{
    return g_uploadDriveLicenseURL;
}

+ (NSString *)getUploadVehicleLicenseURL
{
    return g_uploadVehicleLicenseURL;
}

+ (NSString *)getChexiangWorkbenchURL
{
    return g_chexiangWorkbenchURL;
}
