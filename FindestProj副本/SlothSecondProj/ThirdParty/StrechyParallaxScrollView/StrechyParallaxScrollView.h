...
@protocol StrechyParallaxDelegate <NSObject>

- (void)strechyParallaxDidScroll:(UIScrollView *)scrollView;
- (void)strechyParallaxWillBeginDraggin:(UIScrollView *)scrollView;

@end

@interface StrechyParallaxScrollView : UIView <UIScrollViewDelegate>

@property (nonatomic, weak) id<StrechyParallaxDelegate> delegate;
